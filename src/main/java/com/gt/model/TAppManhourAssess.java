 ...
 */
@Entity
@Table(name = "t_app_manhour_assess", schema = "")
public class TAppManhourAssess extends BasePageForLayUI implements java.io.Serializable {
	...
	private Integer msummanhour;//总工时
	...
	private Float mbranchrate;//支线任务权重

	private Date mcreatedate;//创建时间


	//构造方法
	public TAppManhourAssess() {
	}

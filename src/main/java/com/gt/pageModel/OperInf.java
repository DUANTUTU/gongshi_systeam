...
public class OperInf extends BasePageForLayUI {
	...
	private String sjobid;//职位id
	private String sjobidNm;//职位名称
	private String sjobType;//职位类型
	...
	public String getSjobidNm() {
		return sjobidNm;
	}

	public void setSjobidNm(String sjobidNm) {
		this.sjobidNm = sjobidNm;
	}

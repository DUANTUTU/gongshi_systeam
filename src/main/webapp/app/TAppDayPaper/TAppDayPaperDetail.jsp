    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="dopercd" placeholder="无" autocomplete="off" class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">工时总计</label>
            <div class="layui-input-block">
                <input type="text" name="dsummanhour" placeholder="无" autocomplete="off" class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">主线任务工时</label>
            <div class="layui-input-block">
                <input type="text" name="dmaster" placeholder="无" autocomplete="off" class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">支线任务工时</label>
            <div class="layui-input-block">
                <input type="text" name="dbranch" placeholder="无" autocomplete="off" class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">主线工时权重</label>
            <div class="layui-input-block">
                <input type="text" name="dmasterrate" placeholder="无" autocomplete="off" class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">支线工时权重</label>
            <div class="layui-input-block">
                <input type="text" name="dbranchrate" placeholder="无" autocomplete="off" class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">创建时间</label>
            <div class="layui-input-block">
                <input type="text" name="dcreatedate" placeholder="无" autocomplete="off" class="layui-input"/>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['form', 'layedit', 'table', 'laydate', 'jquery'], function () {
        ...
        table.render({
            elem: '#table',//table id
            url: '<%=request.getContextPath()%>/tAppManhour/getEntitysByOpercdDateToDate?opercd=' + data.dopercd + '&createdate=' + data.dcreatedate + '&type=day',
            method: 'POST', //方式
            cellMinWidth: 100,
            even: true, //开启隔行背景
            id: 'searchID',

	...
	<form name="form" class="layui-form" style="margin-top: 20px;" method="post" action="">
		 ...
		 <div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-block">
					<input type="text" name="pprojectid" maxlength="36"  placeholder="请输入" autocomplete="off" class="layui-input" />
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label"  >里程碑名称</label>
				<div class="layui-input-block">
					<input type="text" name="pplanname" maxlength="200"  placeholder="请输入" autocomplete="off" class="layui-input" />
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label"  >里程碑工时预估</label>
				<div class="layui-input-block">
					<input type="text" name="pplanmanhour" maxlength="2"  placeholder="请输入" autocomplete="off" class="layui-input" />
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label"  >里程碑顺序</label>
				<div class="layui-input-block">
					<input type="text" name="pplanorder" maxlength="2"  placeholder="请输入" autocomplete="off" class="layui-input" />
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label"  >是否完成</label>
				<div class="layui-input-block">
					<input type="text" name="piscomplete" maxlength="1"  placeholder="请输入" autocomplete="off" class="layui-input" />
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label"  >里程碑确认工时</label>
				<div class="layui-input-block">
					<input type="text" name="psummanhour" maxlength="2"  placeholder="请输入" autocomplete="off" class="layui-input" />
				</div>
			</div>
			<div class="layui-inline">
...
layui.use(['form', 'layedit', 'laydate','jquery'], function(){
  ...
  laydate.render({
   ...
   var index = layer.load(1);//开启进度条
      $.ajax({
		url : '<%=request.getContextPath()%>/tAppProjectPlan/modify',
		data : data.field,

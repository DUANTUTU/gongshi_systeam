    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <select name="mjobid" id="mjobid" lay-verify="required"></select>
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label" style="color:#F00">工时设定</label>
            <div class="layui-input-block">
                <input type="text" name="mmanhour" lay-verify="required" maxlength="5" placeholder="请输入" autocomplete="off"
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="mtarget" lay-verify="required" maxlength="1000" placeholder="请输入" autocomplete="off"
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="mdetails" lay-verify="required" maxlength="1000" placeholder="请输入" autocomplete="off"
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
...
<script>
    layui.use(['form', 'layedit', 'laydate', 'jquery'], function () {
        ...
        form.on('submit(btnSubmit)', function (data) {
            ...
            $.ajax({
                url: '<%=request.getContextPath()%>/tAppMeritTemplate/add',
                data: data.field,

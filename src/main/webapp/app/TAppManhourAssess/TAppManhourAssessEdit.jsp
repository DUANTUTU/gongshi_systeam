	...
	<form name="form" class="layui-form" style="margin-top: 20px;" method="post" action="">
		 ...
		 <div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-block">
					<input type="text" name="mopercd" maxlength="36"  placeholder="请输入" autocomplete="off" class="layui-input" />
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label"  >总工时</label>
				<div class="layui-input-block">
					<input type="text" name="msummanhour" maxlength="2"  placeholder="请输入" autocomplete="off" class="layui-input" />
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label"  >主线工时</label>
				<div class="layui-input-block">
					<input type="text" name="mmaster" maxlength="2"  placeholder="请输入" autocomplete="off" class="layui-input" />
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label"  >支线工时</label>
				<div class="layui-input-block">
					<input type="text" name="mbranch" maxlength="2"  placeholder="请输入" autocomplete="off" class="layui-input" />
				</div>
			</div>
			<div class="layui-inline">
...
layui.use(['form', 'layedit', 'laydate','jquery'], function(){
  ...
  laydate.render({
   ...
   var index = layer.load(1);//开启进度条
      $.ajax({
		url : '<%=request.getContextPath()%>/tAppManhourAssess/modify',
		data : data.field,

...
<script>
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element'], function () {
        ...
        table.render({
            elem: '#table',//table id
            url: '<%=request.getContextPath()%>/tAppProject/datagridJG',
            method: 'POST', //方式
            page: true,//是否开启分页
        ...
        function openUpdate(data) {
            ...
            layer.open({
                ...
                area: ['100%', '100%'],
                boolean: true,
                content: ['TAppProjectManageEdit.jsp?obj=' + encodeURIComponent(JSON.stringify(data)), 'yes'], //iframe的url，no代表不显示滚动条
                success: function (layero, lockIndex) {
...
<script type="text/html" id="toobar">
    ...
    <a class="layui-btn layui-btn-xs "lay-event="update">监管</a>
</script>

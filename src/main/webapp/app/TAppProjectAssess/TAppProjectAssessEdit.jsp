...
<form name="form" class="layui-form" style="margin-top: 20px;" method="post" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="pcompleterate" maxlength="2" placeholder="请输入" autocomplete="off"
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="pfinishhour" maxlength="2" placeholder="请输入" autocomplete="off"
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="pfinishhourrate" maxlength="2" placeholder="请输入" autocomplete="off"
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="punfinishhour" maxlength="2" placeholder="请输入" autocomplete="off"
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-inline">
...
<script>
    layui.use(['form', 'layedit', 'laydate', 'jquery'], function () {
        ...
        form.on('submit(btnSubmit)', function (data) {
            ...
            $.ajax({
                url: '<%=request.getContextPath()%>/tAppProjectAssess/modify',
                data: data.field,

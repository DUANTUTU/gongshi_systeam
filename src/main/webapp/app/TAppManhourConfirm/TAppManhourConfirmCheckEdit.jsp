...
<%--        </div>--%>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">debug工时</label>
            <div class="layui-input-block">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            ...
            <button class="layui-btn layui-btn-danger" lay-submit="" lay-filter="notokSubmit">拒绝</button>
...
<script>
    layui.use(['form', 'layedit', 'laydate', 'jquery'], function () {
        ...
        form.on('submit(okSubmit)', function (data) {
            ...
            $.ajax({
                url: '<%=request.getContextPath()%>/tAppManhourConfirm/modifyShenHe?type=okSubmit',
                data: data.field,
        ...
        form.on('submit(notokSubmit)', function (data) {
            ...
            var index = layer.load(1);//开启进度条
            $.ajax({
                url: '<%=request.getContextPath()%>/tAppManhourConfirm/modifyShenHe?type=notokSubmit',
                data: data.field,
                type: 'POST',//默认以get提交，以get提交如果是中文后台会出现乱码
                dataType: 'json',
                success: function (obj) {

...
<div class="layui-tab">
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <jsp:include page="TAppBuginfoSearch.jsp"></jsp:include>
        </div>
    </div>
</div>
...
<script>
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element'], function () {
        ...
        table.render({
            elem: '#table',//table id
            url: '<%=request.getContextPath()%>/tAppBuginfo/datagrid',
            method: 'POST', //方式
            page: true,//是否开启分页
            ...
            cols: [[ //标题栏
                {checkbox: true},
				{field: 'id', title: '',align: 'center', sort: true},
				{field: 'title', title: '标题',align: 'center', sort: true},
				{field: 'content', title: '内容',align: 'center', sort: true},
				{field: 'responsiblePerson', title: '负责人',align: 'center', sort: true},
				{field: 'submitter', title: '提交人',align: 'center', sort: true},
				{field: 'status', title: '状态',align: 'center', sort: true},
				{field: 'createdTime', title: '',align: 'center', sort: true},
				{field: 'updatedTime', title: '',align: 'center', sort: true},
				{field: 'estimatedTime', title: '预计时间',align: 'center', sort: true},
				{field: 'projectName', title: '项目名称',align: 'center', sort: true},
				{field: 'projectId', title: '项目id',align: 'center', sort: true},
				{field: 'projectMilestones', title: '项目里程碑', align: 'center', sort: true},
        ...
        function openAdd() {
            layer.open({
                ...
                area: ['100%', '100%'],
                boolean: true,
                content: ['TAppBuginfoAdd.jsp', 'yes'], //iframe的url，no代表不显示滚动条
        ...
        function openDetail(data) {
            layer.open({
                ...
                area: ['100%', '100%'],
                boolean: true,
                content: ['TAppBuginfoDetail.jsp?obj=' + encodeURIComponent(JSON.stringify(data)), 'yes'], //iframe的url，no代表不显示滚动条
                success: function (layero, lockIndex) {
                    var body = layer.getChildFrame('body', lockIndex);
                    //绑定解锁按钮的点击事件
                    body.find('button#close').on('click', function () {
        ...
        function openUpdate(data) {
            layer.open({
                ...
                area: ['100%', '100%'],
                boolean: true,
                content: ['TAppBuginfoEdit.jsp?obj=' + encodeURIComponent(JSON.stringify(data)), 'yes'], //iframe的url，no代表不显示滚动条
                success: function (layero, lockIndex) {
            ...
            layer.open({
                ...
                , success: function (layero) {
                    ...
                    btn.find('.layui-layer-btn0').on('click', function () {
                        ...
                        $.ajax({
                            url: '<%=request.getContextPath()%>/tAppBuginfo/remove',
                            data: {
                    id :
                        ids
                    },

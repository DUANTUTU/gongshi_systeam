...
<body>
	<form name="form" class="layui-form" style="margin-top: 20px;" method="post" action="">
		 ...
		 <div class="layui-form-item">
				...
				<label class="layui-form-label"  style="color:#F00">编码</label>
				<div class="layui-input-block">
					<input type="text" name="id" maxlength="2" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input" />
				</div>
			</div>
			<div class="layui-inline">
...
layui.use(['form', 'layedit', 'laydate','jquery'], function(){
  ...
  var laydate= layui.laydate;
   ...
   var index = layer.load(1);//开启进度条
      $.ajax({
		url : '<%=request.getContextPath()%>/test3/modify',
		data : data.field,

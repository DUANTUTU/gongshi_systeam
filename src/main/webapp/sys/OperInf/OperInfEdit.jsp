...
<form class="layui-form" style="margin-top: 20px;" method="post" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            ...
            <input type="text" name="insCdNm" id="insCdNm" lay-verify="required" readOnly="readOnly" placeholder="请选择"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="sjobid" id="sjobid" lay-verify="required"> </select>
        </div>
    </div>
    <!-- 按钮组 -->
    <div class="layui-form-item">
...
<script>
    layui.use(['form', 'layedit', 'laydate', 'jquery'], function () {
        ...
        pbInitComCombox($, form, 'tSysJob/getList', 'sjobid', 'id', 'jname',data.sjobid);
        //初始化岗位下拉框
...
<script>
    layui.use(['form', 'layedit', 'laydate', 'jquery'], function () {
        ...
        var data =JSON.parse(decodeURIComponent(getRequestParam().obj));
        // var body = $(layero).find("iframe")[0].contentWindow.document;
        // var jobId=body.getElementById("sjobid").value;
        // var jobIdNm=body.getElementById("sjobidNm").value;
        // debugger
        //初始化下拉框

...
<form class="layui-form" style="margin-top: 20px;" method="post" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="email" maxlength="100" placeholder="无" lay-verify="email" autocomplete="off"
                   class="layui-input"/>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            ...
            <input type="text" name="insCdNm" id="insCdNm" readOnly="readOnly" placeholder="请选择" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
